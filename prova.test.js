...
describe('Prova de Lógica JavaScript', () => {
  ...
  const manipulacaoObjeto = require('./q6'); // Ajuste o caminho conforme necessário
  ...
  const manipularArray = require('./caminhoParaManipularArray');  // Ajuste o caminho conforme necessário
  ...
  describe('Q10: Manipulação de Array de Números', () => {
    test('Verifica a manipulação correta do array e cálculos resultantes', () => {
      ...
      expect(resultado.arrayCopia).toEqual([2, 3, 4]); // Após adicionar 0 e 10, e remover o primeiro e último elementos.
      ...
      expect(resultado.maiorNumero).toBe(4);
